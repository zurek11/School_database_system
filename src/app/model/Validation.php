...
class Validation {
     ...
     */
    public function get_errors($convert_to_string = null) {
        ...
        foreach ($this->errors as $e) {
            ...
            $pField = mb_strtolower($field, 'UTF-8');

            switch ('gb') {
                case 'sk':
                    switch ($e['rule']) {
                        case 'mismatch' :
                            $resp[$field] = "Neexistuje žiadne pravidlo validácie pre $pField";
                            break;
                        case 'validate_required':
                            $resp[$field] = "Pole $pField je povinné";
                            break;
                        case 'validate_valid_email':
                            $resp[$field] = "V poli $pField musí byť platný e-mail";
                            break;
                        case 'validate_max_len':
                            $resp[$field] = "Pole $field musí mať dĺzku $param znakov alebo menej";
                            break;
                        case 'validate_min_len':
                            $resp[$field] = "Pole $pField musí mať dĺzku $param znakov alebo viac";
                            break;
                        case 'validate_exact_len':
                            $resp[$field] = "Pole $pField musí mať dĺžku presne $param znakov";
                            break;
                        case 'validate_alpha':
                            $resp[$field] = "Pole $pField môže obsahovať len znaky a-z";
                            break;
                        case 'validate_alpha_numeric':
                            $resp[$field] = "Pole $pField môže obsahovať len alfanumerické znaky";
                            break;
                        case 'validate_alpha_dash':
                            $resp[$field] = "Pole $pField môže obsahovať len znaky abecedy &amp; čiarky";
                            break;
                        case 'validate_numeric':
                            $resp[$field] = "Pole $pField môže obsahovať len číselné znaky";
                            break;
                        case 'validate_integer':
                            $resp[$field] = "Pole $pField môže obsahovať len celé čísla";
                            break;
                        case 'validate_equalsfield':
                            $resp[$field] = "Pole $pField sa nezhoduje s " . strtolower($translation[lcfirst($param)]);
                            break;
                        case 'validate_boolean':
                            $resp[$field] = "Pole $pField môže obsahovať len pravdivostné hodnoty";
                            break;
                        case 'validate_float':
                            $resp[$field] = "Pole $pField môže obsahovať len realne čísla";
                            break;
                        case 'validate_valid_url':
                            $resp[$field] = "Pole $pField musí obsahovať platnú URL adresu";
                            break;
                        case 'validate_url_exists':
                            $resp[$field] = "$field neexistuje";
                            break;
                        case 'validate_valid_ip':
                            $resp[$field] = "Pole $pField musí obsahovať platnú IP adresu";
                            break;
                        case 'validate_valid_cc':
                            $resp[$field] = "Pole $pField musí obsahovať platné číslo kreditnej karty";
                            break;
                        case 'validate_valid_name':
                            $resp[$field] = "Pole $pField musí obsahovať platné meno";
                            break;
                        case 'validate_contains':
                            $resp[$field] = "Pole $pField musí obsahovať jednu z týchto hodnôt: ".implode(', ', $param);
                            break;
                        case 'validate_contains_list':
                            $resp[$field] = "Pole $pField musí obsahovať hodnotu zo zoznamu";
                            break;
                        case 'validate_doesnt_contain_list':
                            $resp[$field] = "Pole $pField obsahuje hodnotu, ktorá nie je akceptovaná";
                            break;
                        case 'validate_street_address':
                            $resp[$field] = "Pole $pField musí obsahovať platnú adresu";
                            break;
                        case 'validate_date':
                            $resp[$field] = "Pole $pField musí obsahovať platný formát";
                            break;
                        case 'validate_iban':
                            $resp[$field] = "Pole $pField musí obsahovať platný formát";
                            break;
                        case 'validate_min_numeric':
                            $resp[$field] = "Pole $pField musí obsahovať číselnú hodnotu rovnú alebo väčšiu než $param";
                            break;
                        case 'validate_max_numeric':
                            $resp[$field] = "Pole  $pField musí obsahovať číselnú hodnotu rovnú alebo menšiu než $param";
                            break;
                        case 'validate_min_age':
                            $resp[$field] = "Pole $pField musí obsahovať vek rovný alebo väčší než $param";
                            break;
                        default:
                            $resp[$field] = "Pole $pField je neplatné";
                            break;
                    }
                    break;
                ...
                case 'gb':
                    switch ($e['rule']) {
                        case 'mismatch' :
                            $resp[$field] = "There is no validation rule for $pField";
                            break;
                        case 'validate_required':
                            $resp[$field] = "The $pField field is required";
                            break;
                        case 'validate_valid_email':
                            $resp[$field] = "The $pField field is required to be a valid email address";
                            break;
                        case 'validate_max_len':
                            $resp[$field] = "The $field field needs to be $param or shorter in length";
                            break;
                        case 'validate_min_len':
                            $resp[$field] = "The $pField field needs to be $param or longer in length";
                            break;
                        case 'validate_exact_len':
                            $resp[$field] = "The $pField field needs to be exactly $param characters in length";
                            break;
                        case 'validate_alpha':
                            $resp[$field] = "The $pField field may only contain alpha characters(a-z)";
                            break;
                        case 'validate_alpha_numeric':
                            $resp[$field] = "The $pField field may only contain alpha-numeric characters";
                            break;
                        case 'validate_alpha_dash':
                            $resp[$field] = "The $pField field may only contain alpha characters &amp; dashes";
                            break;
                        case 'validate_numeric':
                            $resp[$field] = "The $pField field may only contain numeric characters";
                            break;
                        case 'validate_integer':
                            $resp[$field] = "The $pField field may only contain a numeric value";
                            break;
                        case 'validate_equalsfield':
                            $resp[$field] = "The $pField field does not equal " . strtolower(lcfirst($param)) . " field";
                            break;
                        case 'validate_boolean':
                            $resp[$field] = "The $pField field may only contain a true or false value";
                            break;
                        case 'validate_float':
                            $resp[$field] = "The $pField field may only contain a float value";
                            break;
                        case 'validate_valid_url':
                            $resp[$field] = "The $pField field is required to be a valid URL";
                            break;
                        case 'validate_url_exists':
                            $resp[$field] = "The $field URL does not exist";
                            break;
                        case 'validate_valid_ip':
                            $resp[$field] = "The $pField field needs to contain a valid IP address";
                            break;
                        case 'validate_valid_cc':
                            $resp[$field] = "The $pField field needs to contain a valid credit card number";
                            break;
                        case 'validate_valid_name':
                            $resp[$field] = "The $pField field needs to contain a valid human name";
                            break;
                        case 'validate_contains':
                            $resp[$field] = "The $pField field needs to contain one of these values: ".implode(', ', $param);
                            break;
                        case 'validate_contains_list':
                            $resp[$field] = "The $pField field needs to contain a value from its drop down list";
                            break;
                        case 'validate_doesnt_contain_list':
                            $resp[$field] = "The $pField field contains a value that is not accepted";
                            break;
                        case 'validate_street_address':
                            $resp[$field] = "The $pField field needs to be a valid street address";
                            break;
                        case 'validate_date':
                            $resp[$field] = "The $pField field needs to be a valid format";
                            break;
                        case 'validate_iban':
                            $resp[$field] = "The $pField field needs to be a valid format";
                            break;
                        case 'validate_min_numeric':
                            $resp[$field] = "The $pField field needs to be a numeric value, equal to, or higher than $param";
                            break;
                        case 'validate_max_numeric':
                            $resp[$field] = "The $pField field needs to be a numeric value, equal to, or lower than $param";
                            break;
                        case 'validate_min_age':
                            $resp[$field] = "The $pField field needs to have an age greater than or equal to $param";
                            break;
                        default:
                            $resp[$field] = "The $pField field is invalid";
                            break;
                    }
                    break;
            }
    ...
    */
    ...
    protected function validate_url_exists($field, $input, $param = null)
    {
        ...
        if ($param == "array") {
            ...
            foreach ($input[$field] as $value) {
                ...
                $url = $url['path'];
                if (((function_exists('checkdnsrr') && checkdnsrr($url) === false)) || (gethostbyname($url) == $url)) {
                    $validate = false;
                    break;
                }
            }
    ...
    protected function validate_date($field, $input, $param = null)
    {
        ...
        if (is_array($param)) {
            ...
            foreach ($input[$field] as $value) {
                $cdate = date($param[0], strtotime($value));
           ...
           $cdate = date($param, strtotime($input[$field]));

            if ($cdate != $input[$field]) {
                $validate = false;
            }
        }
